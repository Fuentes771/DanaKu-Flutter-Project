    ...
    return Scaffold(
      ...
      body: cats.isEmpty
          ? const EmptyState(
              ...
              subtitle:
                  'Tambahkan kategori baru dengan tombol + di kanan bawah',
            )
          : ListView.separated(
              ...
              itemBuilder: (context, index) {
                final c = cats[index];
                final icon = c.type == CategoryType.expense
                    ? Icons.remove_circle
                    : Icons.add_circle;
                final usedCount = _countUsage(txs, c.id);
                final color = c.type == CategoryType.expense
                    ? Colors.red
                    : Colors.green;
                return Dismissible(
                    ...
                    if (usedCount > 0) {
                      await showDialog<void>(
                        ...
                        builder: (ctx) => AlertDialog(
                          ...
                          content: Text(
                            'Kategori ini dipakai oleh $usedCount transaksi. Hapus atau ubah transaksi terkait terlebih dahulu.',
                          ),
                          actions: [
                            TextButton(
                  ...
                  onDismissed: (_) =>
                      ref.read(categoriesProvider.notifier).remove(c.id),
                  child:
                      Container(
      ...
      actions: [
        ...
        FilledButton(
          onPressed: () {
            ...
            Navigator.of(
              context,
            ).pop(_NewCategoryResult(_nameCtrl.text.trim(), _type));
          },
